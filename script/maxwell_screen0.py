...
bempp.api.export("./maxwell_screen0.msh", grid, write_binary=False)
...
im = axs.imshow(squared_field_density.reshape((nx, nz)).T,
                cmap='coolwarm', origin='lower',
                extent=[-extent, extent, -extent, extent], vmax=4)
axs.plot([-.5, -2], [0, 2], 'k-', linewidth=4)
axs.plot([.5, 2], [0, 2], 'k-', linewidth=4)
axs.plot([-1, 1], [-1, -1], 'k-', linewidth=4)


fig.colorbar(im, ax=axs)
axs.set_title("Squared Electric Field Density")
fig.savefig("./maxwell_screen0.png")
...
fig.savefig("./maxwell_screen0_pnt.png")
