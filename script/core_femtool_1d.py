...
from OCC.Core.FairCurve import FairCurve_MinimalVariation, FairCurve_Energy, FairCurve_Newton
from OCC.Core.FairCurve import FairCurve_DistributionOfEnergy
